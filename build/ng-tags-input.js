 ...
 * License: MIT
 *
 * Generated at 2016-08-01 11:44:22 +0200
 */
(function() {
'use strict';
...
tagsInput.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put('ngTagsInput/auto-complete.html',
    "<div class=\"autocomplete\" ng-if=\"suggestionList.visible\"><ul class=\"suggestion-list\"><li class=\"suggestion-item\" ng-repeat=\"item in suggestionList.items track by track(item)\" ng-class=\"getSuggestionClass(item, $index)\" ng-click=\"addSuggestionByIndex($index)\" ng-mouseenter=\"suggestionList.select($index)\"><span class=\"swatch\" style=\"{{getInlineStyles(item)}}\"></span><ti-autocomplete-match scope=\"templateScope\" data=\"::item\"></ti-autocomplete-match></li><li class=\"helptext\" ng-if=\"suggestionList.total > 10\">top <strong>{{suggestionList.items.length}}</strong> results shown of <strong>{{suggestionList.total}}</strong> matches</li><li class=\"helptext\" ng-if=\"suggestionList.total < 1\">no matches</li></ul></div>"
  );
